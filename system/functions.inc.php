...
function curl_login_gogs($user_name,$password){
	...
	$set_cookie_status = (set_cookie_without_prefix('i_like_gogits',$cookie['i_like_gogits'],null,'/',G_TOP_COOKIE_DOMAIN)&&set_cookie_without_prefix('_csrf',$cookie['_csrf'],null,'/',G_TOP_COOKIE_DOMAIN));
